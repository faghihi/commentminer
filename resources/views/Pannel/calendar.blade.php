...
<head>
  ...
  <!-- Vendor CSS -->
  <link rel="stylesheet" href="examples/css/fullcalendar.min.css">
...
<body class="layout-container ls-top-navbar si-l3-md-up">
    ...
    <ul class="nav navbar-nav hidden-md-down">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu dropdown-menu-list" aria-labelledby="Preview">
          ...
          <a href="calendar.blade.php" class="dropdown-item active">Calendar</a>
  ...
  <div class="sidebar sidebar-light bg-white" id="sidebar-calendar" data-position="right" data-visible="none" data-scrollable>
    <div class="p-a-1 bg-faded">
      <a href="#" class="text-muted" data-toggle="sidebar" data-target="#sidebar-calendar">Close <i class="material-icons pull-xs-right">close</i></a>
    </div>
  ...
  <div class="layout-content" data-scrollable>
    <div class="container-fluid">
      ...
      <p>
        <a href="#" class="btn btn-danger btn-sm btn-rounded-deep" data-toggle="modal" data-target="#myModal"><i class="material-icons">add</i> <span class="icon-text">Add Event</span></a>
      </p>
  ...
  <!-- Init -->
  <script src="examples/js/fullcalendar.js"></script>
