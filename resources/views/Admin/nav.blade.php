<nav class="navbar navbar-dark bg-primary navbar-full navbar-fixed-top">
    ...
    <!-- Brand -->
    <a href="/AdminPannel"  class="navbar-brand first-child-md">کامنت ماینر</a>

    <!-- Menu -->
    <ul class="nav navbar-nav pull-xs-left hidden-sm-down nav-strip-left">
        ...
        <!-- User dropdown -->
        <li class="nav-item dropdown" >
            <a dir="rtl" class="nav-link active dropdown-toggle p-a-0" data-toggle="dropdown" href="#" role="button" aria-haspopup="false">
